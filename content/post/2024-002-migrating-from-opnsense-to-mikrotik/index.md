...
slug: migrating-from-opnsense-to-mikrotik
date: "2024-05-15"
tags: [ networking, mikrotik, opnsense ]
image: { path: featured.webp }

description: |
    Bye-bye OPNsense, hello Mikrotik! Upgrading to an RB5009 MikroTik router.
---
...
![OPNsense server with the top panel off, showcasing the internals](./img/opnsense_internals.webp)
...
![OPNsense server, front view showing the 80mm Noctua fans](./img/opnsense_server_front.webp)
...
![OPNsense server, power supply top view](./img/opnsense_server_psu_top.webp)
...
![OPNsense server, 3d-printed power supply bracket](./img/opnsense_server_psu_front.webp)
...
![OPNsense server, rear-io showcasing the network interfaces](./img/opnsense_server_network_interfaces.webp)
...
![Mikrotik RB5009, seen from the front, showcasing the connectivity](./img/mikrotik_front.webp)
...
![Mikrotik RB5009, seen from the side, showcasing the DC power terminal](./img/mikrotik_right_side.webp)
...
![Mikrotik RB5009, seen from the back-right, showcasing the passive heatsink](./img/mikrotik_back_left_side.webp)
...
![Mikrotik K-79 on top of the RB5009](./img/mikrotik_k79.webp)
...
![The OPNsense box, plugged into a Kill-A-Watt meter on the left, and the Mikrotik on the right, showcasing their power draw](./img/power_consumption_comparison.webp)
...
![The Cisco SG350-10 on top of the SG300-52](./img/cisco_switches.webp)
...
![The RouterOS Provider Page on registry.terraform.io](./img/terraform_routeros.webp)
...
![The Mikrotik, mounted into the rack](./img/mikrotik_racked.gif)
...
![The default configuration present on the Mikrotik](./img/mikrotik_default_config.webp)
...
![The default DHCP server configuration](./img/mikrotik_dhcp_server.webp)
...
![The IP address of my workstation, as served by the DHCP server](./img/terminal_ip.webp)
...
![The default firewall rules](./img/mikrotik_firewall_rules.webp)
...
![The default configuration, exported](./img/mikrotik_export.webp)
...
📹 [Watch Video](https://www.youtube.com/watch?v=k5eShv6l1ts)
