...
![Virtualizing VS. Running on bare metal](./img/drake-meme.webp)
...
![My OPNsense Box](./img/network-server.webp)
_My OPNsense Box_
...
![My TrueNAS Appliance and its emotional support foam roller](./img/storage-server.webp)
...
![My 2U backup server](./img/backup-server.webp)
...
![My Virtualization Server](./img/virtualization-server.webp)
...
![Kubernetes Certified Nerd](./img/kubernetes-certifications.webp)
...
![3x Pi4 with 2Gb RAM](./img/management-cluster.webp)
...
![A couple Odroid boards and a Pi4 4Gb dedicated to running workloads](./img/main-cluster-workers.webp)
...
![A couple of Odroid HC1 boards for Longhorn](./img/main-cluster-storage.webp)
...
![Infrastructure-as-Code Tools](./img/infrastructure-as-code-tools.webp)
...
![Monitoring Tools](./img/monitoring-tools.webp)
_Monitoring Tools_
