...
<!-- Blog thumbnail: the mikrotik on the table with a speech bubble: "UPGRADE TIME"

YouTube Thumbnail:
  - top text: out with the
  - bottom text: in with the
  - me holding the opnsense box in one hand and the mikrotik in the other -->
